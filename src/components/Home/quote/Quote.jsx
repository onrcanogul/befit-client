        ...
        <div className='quote'>
            <Grid container spacing={2} alignItems="center">
                ...
                {isAuthenticated() === false ? <Grid item xs={12} sm={3}>
                    <Button color='success' variant='contained' style={{ width: '48%', marginRight: '5px', height: '50px' }} onClick={() => navigator('/auth')} >Giriş Yap</Button>
                    <Button color='info' variant='contained' style={{ width: '48%', height: '50px' }} onClick={() => navigator('/auth')} >Kayıt Ol</Button>
